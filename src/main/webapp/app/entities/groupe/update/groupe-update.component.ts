...
export class GroupeUpdateComponent implements OnInit {
  ...
  protected updateForm(groupe: IGroupe): void {
    this.editForm.patchValue({
      ...
      groupeCode: groupe.groupeCode,
      habilitationLevel: groupe.habilitationLevel,
    });
  }
  ...
  protected createFromForm(): IGroupe {
    return {
      ...
      groupeCode: this.editForm.get(['groupeCode'])!.value,
      habilitationLevel: this.editForm.get(['habilitationLevel'])!.value,
    };
  }
}

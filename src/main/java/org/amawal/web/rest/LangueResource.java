...
/**
 * REST controller for managing {@link org.amawal.domain.Langue}.
 */
@RestController
@RequestMapping("/api")
public class LangueResource {
    ...
    public ResponseEntity<Langue> createLangue(@RequestBody Langue langue) throws URISyntaxException {
        ...
        Langue result = langueService.save(langue);
    ...
    public ResponseEntity<Langue> partialUpdateLangue(
        ...
        Optional<Langue> result = langueService.partialUpdate(langue);
    ...
    public ResponseEntity<Langue> getLangue(@PathVariable Long id) {
        ...
        Optional<Langue> langue = langueService.findOne(id);

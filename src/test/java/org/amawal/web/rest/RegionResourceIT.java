...
class RegionResourceIT {
    ...
    private static final Long DEFAULT_REGIN_ID = 1L;
    private static final Long UPDATED_REGIN_ID = 2L;

    private static final String DEFAULT_REGION_NOM = "AAAAAAAAAA";
    private static final String UPDATED_REGION_NOM = "BBBBBBBBBB";
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().reginId(DEFAULT_REGIN_ID).regionNom(DEFAULT_REGION_NOM).pays(DEFAULT_PAYS);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().reginId(UPDATED_REGIN_ID).regionNom(UPDATED_REGION_NOM).pays(UPDATED_PAYS);
        return region;
    }
    ...
    void createRegion() throws Exception {
        ...
        assertThat(testRegion.getReginId()).isEqualTo(DEFAULT_REGIN_ID);
        assertThat(testRegion.getRegionNom()).isEqualTo(DEFAULT_REGION_NOM);
        assertThat(testRegion.getPays()).isEqualTo(DEFAULT_PAYS);
    }
    ...
    void getAllRegions() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.[*].reginId").value(hasItem(DEFAULT_REGIN_ID.intValue())))
            .andExpect(jsonPath("$.[*].regionNom").value(hasItem(DEFAULT_REGION_NOM)))
    ...
    void getRegion() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.reginId").value(DEFAULT_REGIN_ID.intValue()))
            .andExpect(jsonPath("$.regionNom").value(DEFAULT_REGION_NOM))
    ...
    void putNewRegion() throws Exception {
        ...
        updatedRegion.reginId(UPDATED_REGIN_ID).regionNom(UPDATED_REGION_NOM).pays(UPDATED_PAYS);
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getReginId()).isEqualTo(UPDATED_REGIN_ID);
        assertThat(testRegion.getRegionNom()).isEqualTo(UPDATED_REGION_NOM);
        assertThat(testRegion.getPays()).isEqualTo(UPDATED_PAYS);
    }
    ...
    void partialUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.reginId(UPDATED_REGIN_ID).pays(UPDATED_PAYS);
    ...
    void fullUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.reginId(UPDATED_REGIN_ID).regionNom(UPDATED_REGION_NOM).pays(UPDATED_PAYS);

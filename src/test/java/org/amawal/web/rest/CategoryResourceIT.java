...
import org.amawal.domain.Category;
import org.amawal.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    private static final Integer DEFAULT_SECURITY_LEVEL = 1;
    private static final Integer UPDATED_SECURITY_LEVEL = 2;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().categoryId(DEFAULT_CATEGORY_ID).securityLevel(DEFAULT_SECURITY_LEVEL);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().categoryId(UPDATED_CATEGORY_ID).securityLevel(UPDATED_SECURITY_LEVEL);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getSecurityLevel()).isEqualTo(DEFAULT_SECURITY_LEVEL);
    }
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].securityLevel").value(hasItem(DEFAULT_SECURITY_LEVEL)));
    }
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.securityLevel").value(DEFAULT_SECURITY_LEVEL));
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.categoryId(UPDATED_CATEGORY_ID).securityLevel(UPDATED_SECURITY_LEVEL);
        ...
        assertThat(testCategory.getSecurityLevel()).isEqualTo(UPDATED_SECURITY_LEVEL);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryId(UPDATED_CATEGORY_ID).securityLevel(UPDATED_SECURITY_LEVEL);
